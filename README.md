...
- **Result**: The heatmap visualization from clustering and TF-IDF vectorization of movie summaries shows clear distinctions and patterns in how different genres are grouped into clusters. Notably, genres such as "Romantic comedy, Romance Film, Comedy" and "Drama" form distinct clusters, indicating specific narrative structures or themes that are prevalent within these genres. For instance, the "Romantic comedy, Romance Film, Comedy" genre shows a high concentration in Cluster 5, suggesting a unique archetype associated with romantic and comedic elements.The results confirm that clustering and NLP can effectively uncover genre archetypes and their sub-genres. Each cluster represents a grouping of movies that share similar narrative elements, highlighting the utility of this method in exploring and understanding the underlying structures within film genres. This technique allows us to visualize and quantify the relationships between genres and their narrative compositions, providing a valuable tool for industry analysis and academic study in film genre classification.
